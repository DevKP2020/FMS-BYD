...
import ButtonAction from "../materials/ButtonAction";

export default function Navbar({ setOpenModalCard }) {
        ...
        <header className="w-full">
            <nav className="flex items-center justify-between px-6 py-3 bg-white text-dark">
                ...
                <div className="flex items-end items-center">
                    <ButtonAction setOpenModalCard={setOpenModalCard} />
                    <div>
                        <div className={`p-2 mx-3 rounded-xl size-6 ${status ? 'bg-green-500' : 'bg-red-500'}`}>
